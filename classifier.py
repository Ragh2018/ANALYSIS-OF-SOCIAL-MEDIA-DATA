...
sleep = open("dataset/sleep.csv", "r",encoding='latin1').read()
load = open("dataset/load.csv", "r",encoding='latin1').read()
depression = open("dataset/depression.csv", "r",encoding='latin1').read()
antisocial = open("dataset/antisocial.csv", "r",encoding='latin1').read()
angry = open("dataset/angry.csv", "r",encoding='latin1').read()
